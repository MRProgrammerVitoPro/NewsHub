                ...
                <div class="card-body register-card-body">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <input id="name" name="name" type="text" class="form-control" placeholder="Логин" value="{{ old('name') }}">
                        ...
                        <div class="input-group mb-3">
                            <input id="email" name="email" type="email" class="form-control" placeholder="Электронный адрес" value="{{ old('email') }}">
                            <div class="input-group-append">
                                <div class="input-group-text">
